...
class Choice(tkinter.Frame):
    ...
    def __init__(self, master=None, items=None, selection=None, flavor='radio', stacking='vertical', on_change=None, megaconfig=None):
        """
...
```python
class ChoiceDialog(tkinter.Toplevel):
    """
    Toplevel widget, e.g. for dialogs.
    """

    def __init__(self, master=None, title=None, header=None, message=None, items=None, selection=None, flavor='radio', on_close=None, geometry=None, megaconfig=None):
        """
