...
|hook|setter|None||
|indent|getter|None||
|nodes|getter|Returns sequence of nodes. Check the method 'node()' to see how an individual node data structure looks like.||
|root|getter|None||
|spacing|getter|None||
...
## \_Tree\_\_build\_node
None



**Signature:** (self, parent, title, index, data, container, expand)
...
## \_Tree\_\_build\_node\_frame
None



**Signature:** (self, parent, index)
...
## \_Tree\_\_check\_non\_root\_node\_is\_legal
None



**Signature:** (self, parent\_id, index)
...
**Signature:** (self, parent, from\_index, direction='+')
...
**Signature:** (self, master=None, indent=50, spacing=10, megaconfig=None)
...
**Signature:** (self, node\_id, \*args, \*\*kwargs)
...
**Signature:** (self, parent=None, title='', index='end', data=None, container=True, expand=False)
...
**Signature:** (self, node\_id, parent\_id=None, index=0)
...
**Signature:** (self, node\_id, data=None)
...
**Signature:** (self, node\_id, title=None)
